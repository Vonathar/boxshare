...
class CorsaroNeroTest {
  ...
  public void getResults() {
    quickResults = corsaroNero.search("linux", SearchMethod.QUICK);
    smartResults = corsaroNero.search("linux", SearchMethod.SMART);
    completeResults = corsaroNero.search("linux", SearchMethod.COMPLETE);
  }
